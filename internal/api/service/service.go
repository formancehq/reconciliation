...
type Store interface {
	...
	SnoozeAlert(ctx context.Context, id uuid.UUID, snooze *models.Snooze) (*models.Alert, error)
	UnsnoozeAlert(ctx context.Context, id uuid.UUID, by string, actor *models.Actor) (*models.Alert, error)
