...
//
//	mockgen -source backend.go -destination backend_generated.go -package backend
//
...
// VerifySealIntegrity mocks base method.
func (m *MockService) VerifySealIntegrity(ctx context.Context, periodID string) (bool, string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "VerifySealIntegrity", ctx, periodID)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(string)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
...
// VerifySealIntegrity indicates an expected call of VerifySealIntegrity.
func (mr *MockServiceMockRecorder) VerifySealIntegrity(ctx, periodID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "VerifySealIntegrity", reflect.TypeOf((*MockService)(nil).VerifySealIntegrity), ctx, periodID)
}
