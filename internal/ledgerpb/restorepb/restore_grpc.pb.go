...
func (UnimplementedRestoreServiceServer) StartDownloadBackup(context.Context, *StartDownloadBackupRequest) (*StartDownloadBackupResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method StartDownloadBackup not implemented")
}
...
func (UnimplementedRestoreServiceServer) ValidateRestore(*ValidateRestoreRequest, grpc.ServerStreamingServer[ValidateRestoreEvent]) error {
	return status.Errorf(codes.Unimplemented, "method ValidateRestore not implemented")
}
...
func (UnimplementedRestoreServiceServer) FinalizeRestore(context.Context, *FinalizeRestoreRequest) (*FinalizeRestoreResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FinalizeRestore not implemented")
}
