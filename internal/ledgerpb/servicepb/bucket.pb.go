...
const (
	...
	// created (no CreateLedger event). Such a row exposes an unaudited ledger through ListLedgers while
	...
	// CreatedTransaction / RevertedTransaction log payloads: a stored reference the audit never assigned, a missing
	...
	// decoded from the chain-bound AuditItem orders), and VolumeCount / MetadataCount / ReferenceCount against a
	...
	// Emitted when signing verification could not cover the whole history: the
	// live audit range was cut short by a hash chain break, so every signing
	// order recorded after the break is unread. The pass reports this rather
	// than presenting a partial replay as a clean comparison. Signing
	// expectations are never seeded from the live projection -- that would
	// verify old, never-touched keys against a copy of themselves.
	...
	// history: the live audit range was cut short by a hash chain break, so any
	// policy update recorded after the break is unread. The pass reports this
	// rather than presenting a partial replay as clean.
...
type Request_SetMaintenanceMode struct {
	SetMaintenanceMode *SetMaintenanceModeRequest `protobuf:"bytes,9,opt,name=set_maintenance_mode,json=setMaintenanceMode,proto3,oneof"`
}

type Request_SetMetadataFieldType struct {
	SetMetadataFieldType *SetMetadataFieldTypeRequest `protobuf:"bytes,10,opt,name=set_metadata_field_type,json=setMetadataFieldType,proto3,oneof"`
}

type Request_RemoveMetadataFieldType struct {
	RemoveMetadataFieldType *RemoveMetadataFieldTypeRequest `protobuf:"bytes,11,opt,name=remove_metadata_field_type,json=removeMetadataFieldType,proto3,oneof"`
}

type Request_PromoteLedger struct {
	PromoteLedger *PromoteLedgerRequest `protobuf:"bytes,12,opt,name=promote_ledger,json=promoteLedger,proto3,oneof"`
}

type Request_CreatePreparedQuery struct {
	CreatePreparedQuery *CreatePreparedQueryRequest `protobuf:"bytes,13,opt,name=create_prepared_query,json=createPreparedQuery,proto3,oneof"`
}

type Request_UpdatePreparedQuery struct {
	UpdatePreparedQuery *UpdatePreparedQueryRequest `protobuf:"bytes,14,opt,name=update_prepared_query,json=updatePreparedQuery,proto3,oneof"`
}

type Request_DeletePreparedQuery struct {
	DeletePreparedQuery *DeletePreparedQueryRequest `protobuf:"bytes,15,opt,name=delete_prepared_query,json=deletePreparedQuery,proto3,oneof"`
}

type Request_CreateIndex struct {
	CreateIndex *CreateIndexRequest `protobuf:"bytes,16,opt,name=create_index,json=createIndex,proto3,oneof"`
}

type Request_DropIndex struct {
	DropIndex *DropIndexRequest `protobuf:"bytes,17,opt,name=drop_index,json=dropIndex,proto3,oneof"`
}

type Request_SaveNumscript struct {
	SaveNumscript *SaveNumscriptRequest `protobuf:"bytes,18,opt,name=save_numscript,json=saveNumscript,proto3,oneof"`
}

type Request_AddAccountType struct {
	AddAccountType *AddAccountTypeLedgerRequest `protobuf:"bytes,19,opt,name=add_account_type,json=addAccountType,proto3,oneof"`
}

type Request_RemoveAccountType struct {
	RemoveAccountType *RemoveAccountTypeLedgerRequest `protobuf:"bytes,20,opt,name=remove_account_type,json=removeAccountType,proto3,oneof"`
}

type Request_SetDefaultEnforcementMode struct {
	SetDefaultEnforcementMode *SetDefaultEnforcementModeLedgerRequest `protobuf:"bytes,21,opt,name=set_default_enforcement_mode,json=setDefaultEnforcementMode,proto3,oneof"`
}

type Request_CreateQueryCheckpoint struct {
	CreateQueryCheckpoint *CreateQueryCheckpointRequest `protobuf:"bytes,22,opt,name=create_query_checkpoint,json=createQueryCheckpoint,proto3,oneof"`
}

type Request_DeleteQueryCheckpoint struct {
	DeleteQueryCheckpoint *DeleteQueryCheckpointRequest `protobuf:"bytes,23,opt,name=delete_query_checkpoint,json=deleteQueryCheckpoint,proto3,oneof"`
}

type Request_SetQueryCheckpointSchedule struct {
	SetQueryCheckpointSchedule *SetQueryCheckpointScheduleRequest `protobuf:"bytes,24,opt,name=set_query_checkpoint_schedule,json=setQueryCheckpointSchedule,proto3,oneof"`
}

type Request_DeleteQueryCheckpointSchedule struct {
	DeleteQueryCheckpointSchedule *DeleteQueryCheckpointScheduleRequest `protobuf:"bytes,25,opt,name=delete_query_checkpoint_schedule,json=deleteQueryCheckpointSchedule,proto3,oneof"`
}

type Request_SaveLedgerMetadata struct {
	SaveLedgerMetadata *SaveLedgerMetadataRequest `protobuf:"bytes,26,opt,name=save_ledger_metadata,json=saveLedgerMetadata,proto3,oneof"`
}
...
const file_bucket_proto_rawDesc = "" +
	...
	"\x12remove_events_sink\x18\b \x01(\v2\x1f.ledger.RemoveEventsSinkRequestH\x00R\x10removeEventsSink\x12U\n" +
	"\x14set_maintenance_mode\x18\t \x01(\v2!.ledger.SetMaintenanceModeRequestH\x00R\x12setMaintenanceMode\x12\\\n" +
	"\x17set_metadata_field_type\x18\n" +
	" \x01(\v2#.ledger.SetMetadataFieldTypeRequestH\x00R\x14setMetadataFieldType\x12e\n" +
	"\x1aremove_metadata_field_type\x18\v \x01(\v2&.ledger.RemoveMetadataFieldTypeRequestH\x00R\x17removeMetadataFieldType\x12E\n" +
	"\x0epromote_ledger\x18\f \x01(\v2\x1c.ledger.PromoteLedgerRequestH\x00R\rpromoteLedger\x12X\n" +
	"\x15create_prepared_query\x18\r \x01(\v2\".ledger.CreatePreparedQueryRequestH\x00R\x13createPreparedQuery\x12X\n" +
	"\x15update_prepared_query\x18\x0e \x01(\v2\".ledger.UpdatePreparedQueryRequestH\x00R\x13updatePreparedQuery\x12X\n" +
	"\x15delete_prepared_query\x18\x0f \x01(\v2\".ledger.DeletePreparedQueryRequestH\x00R\x13deletePreparedQuery\x12?\n" +
	"\fcreate_index\x18\x10 \x01(\v2\x1a.ledger.CreateIndexRequestH\x00R\vcreateIndex\x129\n" +
	"\n" +
	"drop_index\x18\x11 \x01(\v2\x18.ledger.DropIndexRequestH\x00R\tdropIndex\x12E\n" +
	"\x0esave_numscript\x18\x12 \x01(\v2\x1c.ledger.SaveNumscriptRequestH\x00R\rsaveNumscript\x12O\n" +
	"\x10add_account_type\x18\x13 \x01(\v2#.ledger.AddAccountTypeLedgerRequestH\x00R\x0eaddAccountType\x12X\n" +
	"\x13remove_account_type\x18\x14 \x01(\v2&.ledger.RemoveAccountTypeLedgerRequestH\x00R\x11removeAccountType\x12q\n" +
	"\x1cset_default_enforcement_mode\x18\x15 \x01(\v2..ledger.SetDefaultEnforcementModeLedgerRequestH\x00R\x19setDefaultEnforcementMode\x12^\n" +
	"\x17create_query_checkpoint\x18\x16 \x01(\v2$.ledger.CreateQueryCheckpointRequestH\x00R\x15createQueryCheckpoint\x12^\n" +
	"\x17delete_query_checkpoint\x18\x17 \x01(\v2$.ledger.DeleteQueryCheckpointRequestH\x00R\x15deleteQueryCheckpoint\x12n\n" +
	...
	"\aenabled\x18\x01 \x01(\bR\aenabled\"\xa6\x01\n" +
	...
	"\x06ledger\x18\x01 \x01(\tR\x06ledger\x12+\n" +
	"\x05query\x18\x02 \x01(\v2\x15.common.PreparedQueryR\x05query\"u\n" +
	"\x1aUpdatePreparedQueryRequest\x12\x16\n" +
	"\x06ledger\x18\x01 \x01(\tR\x06ledger\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12+\n" +
	"\x06filter\x18\x03 \x01(\v2\x13.common.QueryFilterR\x06filter\"H\n" +
