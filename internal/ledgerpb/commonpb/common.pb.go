...
// AuthScope is the exhaustive set of granular scopes that may guard a fixed
// public-service RPC. The wire values are build-time policy metadata; request
// authentication continues to use the canonical scope strings in the auth
// adapter.
type AuthScope int32

const (
	AuthScope_AUTH_SCOPE_UNSPECIFIED       AuthScope = 0
	AuthScope_AUTH_SCOPE_LEDGER_READ       AuthScope = 1
	AuthScope_AUTH_SCOPE_LEDGER_WRITE      AuthScope = 2
	AuthScope_AUTH_SCOPE_TRANSACTION_READ  AuthScope = 3
	AuthScope_AUTH_SCOPE_TRANSACTION_WRITE AuthScope = 4
	AuthScope_AUTH_SCOPE_ACCOUNT_READ      AuthScope = 5
	AuthScope_AUTH_SCOPE_METADATA_WRITE    AuthScope = 6
	AuthScope_AUTH_SCOPE_AUDIT_READ        AuthScope = 7
	AuthScope_AUTH_SCOPE_AUDIT_WRITE       AuthScope = 8
	AuthScope_AUTH_SCOPE_OPS_READ          AuthScope = 9
	AuthScope_AUTH_SCOPE_OPS_WRITE         AuthScope = 10
	AuthScope_AUTH_SCOPE_QUERY_READ        AuthScope = 11
	AuthScope_AUTH_SCOPE_QUERY_WRITE       AuthScope = 12
	AuthScope_AUTH_SCOPE_CLUSTER_READ      AuthScope = 13
	AuthScope_AUTH_SCOPE_CLUSTER_WRITE     AuthScope = 14
)
...
var (
	AuthScope_name = map[int32]string{
		...
		1:  "AUTH_SCOPE_LEDGER_READ",
		2:  "AUTH_SCOPE_LEDGER_WRITE",
		3:  "AUTH_SCOPE_TRANSACTION_READ",
		4:  "AUTH_SCOPE_TRANSACTION_WRITE",
		5:  "AUTH_SCOPE_ACCOUNT_READ",
		6:  "AUTH_SCOPE_METADATA_WRITE",
		7:  "AUTH_SCOPE_AUDIT_READ",
		8:  "AUTH_SCOPE_AUDIT_WRITE",
		9:  "AUTH_SCOPE_OPS_READ",
		10: "AUTH_SCOPE_OPS_WRITE",
		11: "AUTH_SCOPE_QUERY_READ",
		12: "AUTH_SCOPE_QUERY_WRITE",
		13: "AUTH_SCOPE_CLUSTER_READ",
		14: "AUTH_SCOPE_CLUSTER_WRITE",
	}
	AuthScope_value = map[string]int32{
		"AUTH_SCOPE_UNSPECIFIED":       0,
		"AUTH_SCOPE_LEDGER_READ":       1,
		"AUTH_SCOPE_LEDGER_WRITE":      2,
		"AUTH_SCOPE_TRANSACTION_READ":  3,
		"AUTH_SCOPE_TRANSACTION_WRITE": 4,
		"AUTH_SCOPE_ACCOUNT_READ":      5,
		"AUTH_SCOPE_METADATA_WRITE":    6,
		"AUTH_SCOPE_AUDIT_READ":        7,
		"AUTH_SCOPE_AUDIT_WRITE":       8,
		"AUTH_SCOPE_OPS_READ":          9,
		"AUTH_SCOPE_OPS_WRITE":         10,
		"AUTH_SCOPE_QUERY_READ":        11,
		"AUTH_SCOPE_QUERY_WRITE":       12,
		"AUTH_SCOPE_CLUSTER_READ":      13,
		"AUTH_SCOPE_CLUSTER_WRITE":     14,
	}
)
...
// DynamicAuthResolver names request-dependent policies that cannot be reduced
// to one fixed scope before the request message is inspected.
type DynamicAuthResolver int32

const (
	DynamicAuthResolver_DYNAMIC_AUTH_RESOLVER_UNSPECIFIED            DynamicAuthResolver = 0
	DynamicAuthResolver_DYNAMIC_AUTH_RESOLVER_APPLY                  DynamicAuthResolver = 1
	DynamicAuthResolver_DYNAMIC_AUTH_RESOLVER_GET_INDEX              DynamicAuthResolver = 2
	DynamicAuthResolver_DYNAMIC_AUTH_RESOLVER_GET_INDEX_ENTRY_STATUS DynamicAuthResolver = 3
	DynamicAuthResolver_DYNAMIC_AUTH_RESOLVER_LIST_INDEXES           DynamicAuthResolver = 4
)

// Enum value maps for DynamicAuthResolver.
var (
	DynamicAuthResolver_name = map[int32]string{
		0: "DYNAMIC_AUTH_RESOLVER_UNSPECIFIED",
		1: "DYNAMIC_AUTH_RESOLVER_APPLY",
		2: "DYNAMIC_AUTH_RESOLVER_GET_INDEX",
		3: "DYNAMIC_AUTH_RESOLVER_GET_INDEX_ENTRY_STATUS",
		4: "DYNAMIC_AUTH_RESOLVER_LIST_INDEXES",
	}
	DynamicAuthResolver_value = map[string]int32{
		"DYNAMIC_AUTH_RESOLVER_UNSPECIFIED":            0,
		"DYNAMIC_AUTH_RESOLVER_APPLY":                  1,
		"DYNAMIC_AUTH_RESOLVER_GET_INDEX":              2,
		"DYNAMIC_AUTH_RESOLVER_GET_INDEX_ENTRY_STATUS": 3,
		"DYNAMIC_AUTH_RESOLVER_LIST_INDEXES":           4,
	}
)

func (x DynamicAuthResolver) Enum() *DynamicAuthResolver {
	p := new(DynamicAuthResolver)
	*p = x
	return p
}

func (x DynamicAuthResolver) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (DynamicAuthResolver) Descriptor() protoreflect.EnumDescriptor {
	return file_common_proto_enumTypes[1].Descriptor()
}

func (DynamicAuthResolver) Type() protoreflect.EnumType {
	return &file_common_proto_enumTypes[1]
}

func (x DynamicAuthResolver) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use DynamicAuthResolver.Descriptor instead.
func (DynamicAuthResolver) EnumDescriptor() ([]byte, []int) {
...
const (
	...
	ErrorReason_ERROR_REASON_METADATA_NOT_FOUND               ErrorReason = 18
	ErrorReason_ERROR_REASON_MAINTENANCE_MODE                 ErrorReason = 19
	ErrorReason_ERROR_REASON_STALE_PROPOSAL                   ErrorReason = 20
	ErrorReason_ERROR_REASON_INVALID_CRON_EXPRESSION          ErrorReason = 21
	ErrorReason_ERROR_REASON_LEDGER_IN_MIRROR_MODE            ErrorReason = 22
	ErrorReason_ERROR_REASON_LEDGER_NOT_IN_MIRROR_MODE        ErrorReason = 23
	ErrorReason_ERROR_REASON_PREPARED_QUERY_ALREADY_EXISTS    ErrorReason = 24
	ErrorReason_ERROR_REASON_PREPARED_QUERY_NOT_FOUND         ErrorReason = 25
	ErrorReason_ERROR_REASON_INDEX_NOT_FOUND                  ErrorReason = 26
	ErrorReason_ERROR_REASON_INDEX_BUILDING                   ErrorReason = 27
	ErrorReason_ERROR_REASON_INDEX_INCONSISTENT               ErrorReason = 28
	ErrorReason_ERROR_REASON_METADATA_FIELD_NOT_IN_SCHEMA     ErrorReason = 29
	ErrorReason_ERROR_REASON_NUMSCRIPT_NOT_FOUND              ErrorReason = 30
	ErrorReason_ERROR_REASON_NUMSCRIPT_VERSION_ALREADY_EXISTS ErrorReason = 31
	ErrorReason_ERROR_REASON_NUMSCRIPT_INVALID_VERSION        ErrorReason = 32
	ErrorReason_ERROR_REASON_ACCOUNT_NOT_MATCHING_TYPE        ErrorReason = 33
	ErrorReason_ERROR_REASON_ACCOUNT_TYPE_NOT_FOUND           ErrorReason = 34
	ErrorReason_ERROR_REASON_ACCOUNT_TYPE_ALREADY_EXISTS      ErrorReason = 35
	ErrorReason_ERROR_REASON_INVALID_PATTERN                  ErrorReason = 36
	ErrorReason_ERROR_REASON_ACCOUNT_TYPE_HAS_ACCOUNTS        ErrorReason = 37
	ErrorReason_ERROR_REASON_ACCOUNT_TYPE_CONFLICT            ErrorReason = 38
	ErrorReason_ERROR_REASON_TRANSIENT_ACCOUNT_NON_ZERO       ErrorReason = 39
	ErrorReason_ERROR_REASON_FILTER_COMPILATION_ERROR         ErrorReason = 40
	ErrorReason_ERROR_REASON_INVALID_ORDER_TYPE               ErrorReason = 41
	ErrorReason_ERROR_REASON_INVALID_APPLY_TYPE               ErrorReason = 42
	ErrorReason_ERROR_REASON_INVALID_EXECUTION_PLAN           ErrorReason = 43
	ErrorReason_ERROR_REASON_EXECUTION_PLAN_TOO_LARGE         ErrorReason = 44
	ErrorReason_ERROR_REASON_COVERAGE_MISS                    ErrorReason = 45
	ErrorReason_ERROR_REASON_IDEMPOTENCY_CHECK_FAILED         ErrorReason = 46
	ErrorReason_ERROR_REASON_STORAGE_OPERATION_FAILED         ErrorReason = 47
	ErrorReason_ERROR_REASON_TRANSACTION_STATE_INCONSISTENT   ErrorReason = 48
	ErrorReason_ERROR_REASON_CHECKPOINT_ID_REQUIRED           ErrorReason = 49
	ErrorReason_ERROR_REASON_NUMSCRIPT_RUNTIME                ErrorReason = 50
	ErrorReason_ERROR_REASON_VOLUME_NOT_MATERIALIZED          ErrorReason = 51
	ErrorReason_ERROR_REASON_CLUSTER_UNHEALTHY                ErrorReason = 52
	ErrorReason_ERROR_REASON_WRITES_BLOCKED_DISK_FULL         ErrorReason = 53
	ErrorReason_ERROR_REASON_WRITES_BLOCKED_CLOCK_SKEW        ErrorReason = 54
...
var (
	ErrorReason_name = map[int32]string{
		...
		18: "ERROR_REASON_METADATA_NOT_FOUND",
		19: "ERROR_REASON_MAINTENANCE_MODE",
		20: "ERROR_REASON_STALE_PROPOSAL",
		21: "ERROR_REASON_INVALID_CRON_EXPRESSION",
		22: "ERROR_REASON_LEDGER_IN_MIRROR_MODE",
		23: "ERROR_REASON_LEDGER_NOT_IN_MIRROR_MODE",
		24: "ERROR_REASON_PREPARED_QUERY_ALREADY_EXISTS",
		25: "ERROR_REASON_PREPARED_QUERY_NOT_FOUND",
		26: "ERROR_REASON_INDEX_NOT_FOUND",
		27: "ERROR_REASON_INDEX_BUILDING",
		28: "ERROR_REASON_INDEX_INCONSISTENT",
		29: "ERROR_REASON_METADATA_FIELD_NOT_IN_SCHEMA",
		30: "ERROR_REASON_NUMSCRIPT_NOT_FOUND",
		31: "ERROR_REASON_NUMSCRIPT_VERSION_ALREADY_EXISTS",
		32: "ERROR_REASON_NUMSCRIPT_INVALID_VERSION",
		33: "ERROR_REASON_ACCOUNT_NOT_MATCHING_TYPE",
		34: "ERROR_REASON_ACCOUNT_TYPE_NOT_FOUND",
		35: "ERROR_REASON_ACCOUNT_TYPE_ALREADY_EXISTS",
		36: "ERROR_REASON_INVALID_PATTERN",
		37: "ERROR_REASON_ACCOUNT_TYPE_HAS_ACCOUNTS",
		38: "ERROR_REASON_ACCOUNT_TYPE_CONFLICT",
		39: "ERROR_REASON_TRANSIENT_ACCOUNT_NON_ZERO",
		40: "ERROR_REASON_FILTER_COMPILATION_ERROR",
		41: "ERROR_REASON_INVALID_ORDER_TYPE",
		42: "ERROR_REASON_INVALID_APPLY_TYPE",
		43: "ERROR_REASON_INVALID_EXECUTION_PLAN",
		44: "ERROR_REASON_EXECUTION_PLAN_TOO_LARGE",
		45: "ERROR_REASON_COVERAGE_MISS",
		46: "ERROR_REASON_IDEMPOTENCY_CHECK_FAILED",
		47: "ERROR_REASON_STORAGE_OPERATION_FAILED",
		48: "ERROR_REASON_TRANSACTION_STATE_INCONSISTENT",
		49: "ERROR_REASON_CHECKPOINT_ID_REQUIRED",
		50: "ERROR_REASON_NUMSCRIPT_RUNTIME",
		51: "ERROR_REASON_VOLUME_NOT_MATERIALIZED",
		52: "ERROR_REASON_CLUSTER_UNHEALTHY",
		53: "ERROR_REASON_WRITES_BLOCKED_DISK_FULL",
		54: "ERROR_REASON_WRITES_BLOCKED_CLOCK_SKEW",
		55: "ERROR_REASON_CHECKPOINT_NOT_READY",
		56: "ERROR_REASON_MIRROR_V2_LOG_ID_GAP",
		57: "ERROR_REASON_MIRROR_V2_LOG_ID_INVALID",
		58: "ERROR_REASON_STALE_INPUTS_RESOLUTION",
	...
	ErrorReason_value = map[string]int32{
		...
		"ERROR_REASON_METADATA_NOT_FOUND":               18,
		"ERROR_REASON_MAINTENANCE_MODE":                 19,
		"ERROR_REASON_STALE_PROPOSAL":                   20,
		"ERROR_REASON_INVALID_CRON_EXPRESSION":          21,
		"ERROR_REASON_LEDGER_IN_MIRROR_MODE":            22,
		"ERROR_REASON_LEDGER_NOT_IN_MIRROR_MODE":        23,
		"ERROR_REASON_PREPARED_QUERY_ALREADY_EXISTS":    24,
		"ERROR_REASON_PREPARED_QUERY_NOT_FOUND":         25,
		"ERROR_REASON_INDEX_NOT_FOUND":                  26,
		"ERROR_REASON_INDEX_BUILDING":                   27,
		"ERROR_REASON_INDEX_INCONSISTENT":               28,
		"ERROR_REASON_METADATA_FIELD_NOT_IN_SCHEMA":     29,
		"ERROR_REASON_NUMSCRIPT_NOT_FOUND":              30,
		"ERROR_REASON_NUMSCRIPT_VERSION_ALREADY_EXISTS": 31,
		"ERROR_REASON_NUMSCRIPT_INVALID_VERSION":        32,
		"ERROR_REASON_ACCOUNT_NOT_MATCHING_TYPE":        33,
		"ERROR_REASON_ACCOUNT_TYPE_NOT_FOUND":           34,
		"ERROR_REASON_ACCOUNT_TYPE_ALREADY_EXISTS":      35,
		"ERROR_REASON_INVALID_PATTERN":                  36,
		"ERROR_REASON_ACCOUNT_TYPE_HAS_ACCOUNTS":        37,
		"ERROR_REASON_ACCOUNT_TYPE_CONFLICT":            38,
		"ERROR_REASON_TRANSIENT_ACCOUNT_NON_ZERO":       39,
		"ERROR_REASON_FILTER_COMPILATION_ERROR":         40,
		"ERROR_REASON_INVALID_ORDER_TYPE":               41,
		"ERROR_REASON_INVALID_APPLY_TYPE":               42,
		"ERROR_REASON_INVALID_EXECUTION_PLAN":           43,
		"ERROR_REASON_EXECUTION_PLAN_TOO_LARGE":         44,
		"ERROR_REASON_COVERAGE_MISS":                    45,
		"ERROR_REASON_IDEMPOTENCY_CHECK_FAILED":         46,
		"ERROR_REASON_STORAGE_OPERATION_FAILED":         47,
		"ERROR_REASON_TRANSACTION_STATE_INCONSISTENT":   48,
		"ERROR_REASON_CHECKPOINT_ID_REQUIRED":           49,
		"ERROR_REASON_NUMSCRIPT_RUNTIME":                50,
		"ERROR_REASON_VOLUME_NOT_MATERIALIZED":          51,
		"ERROR_REASON_CLUSTER_UNHEALTHY":                52,
		"ERROR_REASON_WRITES_BLOCKED_DISK_FULL":         53,
		"ERROR_REASON_WRITES_BLOCKED_CLOCK_SKEW":        54,
		"ERROR_REASON_CHECKPOINT_NOT_READY":             55,
		"ERROR_REASON_MIRROR_V2_LOG_ID_GAP":             56,
		"ERROR_REASON_MIRROR_V2_LOG_ID_INVALID":         57,
		"ERROR_REASON_STALE_INPUTS_RESOLUTION":          58,
...
// MethodAuthPolicy requires every public-service RPC to choose exactly one
// authentication policy. protoc-gen-rpcauth rejects missing and invalid
// declarations and generates the runtime fail-closed registry.
type MethodAuthPolicy struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Types that are valid to be assigned to Policy:
	//
	//	*MethodAuthPolicy_Public
	//	*MethodAuthPolicy_FixedScope
	//	*MethodAuthPolicy_DynamicResolver
	Policy        isMethodAuthPolicy_Policy `protobuf_oneof:"policy"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *MethodAuthPolicy) Reset() {
	*x = MethodAuthPolicy{}
...
func (x *MethodAuthPolicy) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MethodAuthPolicy) ProtoMessage() {}

func (x *MethodAuthPolicy) ProtoReflect() protoreflect.Message {
	mi := &file_common_proto_msgTypes[0]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
...
// Deprecated: Use MethodAuthPolicy.ProtoReflect.Descriptor instead.
func (*MethodAuthPolicy) Descriptor() ([]byte, []int) {
	return file_common_proto_rawDescGZIP(), []int{0}
}

func (x *MethodAuthPolicy) GetPolicy() isMethodAuthPolicy_Policy {
	if x != nil {
		return x.Policy
	}
	return nil
...
func (x *MethodAuthPolicy) GetPublic() bool {
	if x != nil {
		if x, ok := x.Policy.(*MethodAuthPolicy_Public); ok {
			return x.Public
		}
	}
	return false
...
func (x *MethodAuthPolicy) GetFixedScope() AuthScope {
	if x != nil {
		if x, ok := x.Policy.(*MethodAuthPolicy_FixedScope); ok {
			return x.FixedScope
		}
	}
...
func (x *MethodAuthPolicy) GetDynamicResolver() DynamicAuthResolver {
	if x != nil {
		if x, ok := x.Policy.(*MethodAuthPolicy_DynamicResolver); ok {
			return x.DynamicResolver
		}
	}
	return DynamicAuthResolver_DYNAMIC_AUTH_RESOLVER_UNSPECIFIED
}

type isMethodAuthPolicy_Policy interface {
	isMethodAuthPolicy_Policy()
}

type MethodAuthPolicy_Public struct {
	Public bool `protobuf:"varint,1,opt,name=public,proto3,oneof"`
}

type MethodAuthPolicy_FixedScope struct {
	FixedScope AuthScope `protobuf:"varint,2,opt,name=fixed_scope,json=fixedScope,proto3,enum=common.AuthScope,oneof"`
}

type MethodAuthPolicy_DynamicResolver struct {
	DynamicResolver DynamicAuthResolver `protobuf:"varint,3,opt,name=dynamic_resolver,json=dynamicResolver,proto3,enum=common.DynamicAuthResolver,oneof"`
}

func (*MethodAuthPolicy_Public) isMethodAuthPolicy_Policy() {}

func (*MethodAuthPolicy_FixedScope) isMethodAuthPolicy_Policy() {}

func (*MethodAuthPolicy_DynamicResolver) isMethodAuthPolicy_Policy() {}
...
type Posting struct {
	...
	// Color of the funds being moved. The empty string is the "uncolored" bucket
	// and is treated as just another color from a segregation standpoint.
	// Color values are constrained to ^[A-Z]*$ at admission time.
...
func (x *Posting) GetColor() string {
	if x != nil {
		return x.Color
	}
	return ""
...
type Transaction struct {
	...
	// Post-commit volumes for every (account, asset, color) tuple touched by
	// this transaction, captured at the transaction's sequence. Immutable
	// historical snapshot: never recomputed from current balances.
	PostCommitVolumes *PostCommitVolumes `protobuf:"bytes,12,opt,name=post_commit_volumes,json=postCommitVolumes,proto3" json:"post_commit_volumes,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
// entries for a single account. Sorted by (asset, color) ascending so the
// serialization is deterministic and stable across reads.
type VolumesByAssets struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Volumes       []*VolumeEntry         `protobuf:"bytes,1,rep,name=volumes,proto3" json:"volumes,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
// VolumeEntry is one (asset, color) row inside VolumesByAssets. The empty
// color is the uncolored bucket and is itself just another segregated bucket.
type VolumeEntry struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Asset         string                 `protobuf:"bytes,1,opt,name=asset,proto3" json:"asset,omitempty"`
	Color         string                 `protobuf:"bytes,2,opt,name=color,proto3" json:"color,omitempty"`
	Volumes       *Volumes               `protobuf:"bytes,3,opt,name=volumes,proto3" json:"volumes,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *VolumeEntry) GetColor() string {
	if x != nil {
		return x.Color
	}
	return ""
...
func (x *VolumeEntry) GetVolumes() *Volumes {
	if x != nil {
		return x.Volumes
	}
	return nil
...
// PostCommitVolumes represents volumes after commit, grouped by account.
// Within each account, entries are flat-listed per (asset, color) tuple.
...
// AccountVolume is one (asset, color) row in Account.volumes.
type AccountVolume struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Asset         string                 `protobuf:"bytes,1,opt,name=asset,proto3" json:"asset,omitempty"`
	Color         string                 `protobuf:"bytes,2,opt,name=color,proto3" json:"color,omitempty"`
	Volumes       *VolumesWithBalance    `protobuf:"bytes,3,opt,name=volumes,proto3" json:"volumes,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *AccountVolume) GetColor() string {
	if x != nil {
		return x.Color
	}
	return ""
...
func (x *AccountVolume) GetVolumes() *VolumesWithBalance {
	if x != nil {
		return x.Volumes
	}
	return nil
...
type Account struct {
	...
	// Volumes is a sorted list of per (asset, color) entries.
	// Sorted by (asset, color) ascending for stable serialization.
	// When the request opts into collapse_colors, the list collapses to one
	// entry per asset with color = "" and amounts summed across colors.
	Volumes       []*AccountVolume `protobuf:"bytes,6,rep,name=volumes,proto3" json:"volumes,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Account) GetVolumes() []*AccountVolume {
	if x != nil {
		return x.Volumes
	}
	return nil
...
// index registry. Holds its identifier, scope and audit metadata. Build
// progress is a per-replica concern surfaced through
// `readstore.IndexVersionState` (see forward_encoding_version below).
//
// Scope:
...
type Index struct {
	...
	Ledger    string                 `protobuf:"bytes,3,opt,name=ledger,proto3" json:"ledger,omitempty"` // empty for bucket-scoped indexes
...
func (x *LogPayload) GetSetClusterPolicy() *SetClusterPolicyLog {
	if x != nil {
		if x, ok := x.Type.(*LogPayload_SetClusterPolicy); ok {
...
type LogPayload_SetMaintenanceMode struct {
	SetMaintenanceMode *SetMaintenanceModeLog `protobuf:"bytes,9,opt,name=set_maintenance_mode,json=setMaintenanceMode,proto3,oneof"`
}

type LogPayload_PromoteLedger struct {
	PromoteLedger *PromotedLedgerLog `protobuf:"bytes,10,opt,name=promote_ledger,json=promoteLedger,proto3,oneof"`
}

type LogPayload_CreatedPreparedQuery struct {
	CreatedPreparedQuery *CreatedPreparedQueryLog `protobuf:"bytes,11,opt,name=created_prepared_query,json=createdPreparedQuery,proto3,oneof"`
}

type LogPayload_UpdatedPreparedQuery struct {
	UpdatedPreparedQuery *UpdatedPreparedQueryLog `protobuf:"bytes,12,opt,name=updated_prepared_query,json=updatedPreparedQuery,proto3,oneof"`
}

type LogPayload_DeletedPreparedQuery struct {
	DeletedPreparedQuery *DeletedPreparedQueryLog `protobuf:"bytes,13,opt,name=deleted_prepared_query,json=deletedPreparedQuery,proto3,oneof"`
}

type LogPayload_SavedNumscript struct {
	SavedNumscript *SavedNumscriptLog `protobuf:"bytes,14,opt,name=saved_numscript,json=savedNumscript,proto3,oneof"`
}

type LogPayload_CreatedQueryCheckpoint struct {
	CreatedQueryCheckpoint *CreatedQueryCheckpointLog `protobuf:"bytes,15,opt,name=created_query_checkpoint,json=createdQueryCheckpoint,proto3,oneof"`
}

type LogPayload_DeletedQueryCheckpoint struct {
	DeletedQueryCheckpoint *DeletedQueryCheckpointLog `protobuf:"bytes,16,opt,name=deleted_query_checkpoint,json=deletedQueryCheckpoint,proto3,oneof"`
}

type LogPayload_SetQueryCheckpointSchedule struct {
	SetQueryCheckpointSchedule *SetQueryCheckpointScheduleLog `protobuf:"bytes,17,opt,name=set_query_checkpoint_schedule,json=setQueryCheckpointSchedule,proto3,oneof"`
}

type LogPayload_DeleteQueryCheckpointSchedule struct {
	DeleteQueryCheckpointSchedule *DeletedQueryCheckpointScheduleLog `protobuf:"bytes,18,opt,name=delete_query_checkpoint_schedule,json=deleteQueryCheckpointSchedule,proto3,oneof"`
}

type LogPayload_SavedLedgerMetadata struct {
	SavedLedgerMetadata *SavedLedgerMetadataLog `protobuf:"bytes,19,opt,name=saved_ledger_metadata,json=savedLedgerMetadata,proto3,oneof"`
}

type LogPayload_DeletedLedgerMetadata struct {
	DeletedLedgerMetadata *DeletedLedgerMetadataLog `protobuf:"bytes,20,opt,name=deleted_ledger_metadata,json=deletedLedgerMetadata,proto3,oneof"`
}

type LogPayload_SetClusterPolicy struct {
	SetClusterPolicy *SetClusterPolicyLog `protobuf:"bytes,21,opt,name=set_cluster_policy,json=setClusterPolicy,proto3,oneof"`
}
...
func (*LogPayload_SetClusterPolicy) isLogPayload_Type() {}
...
// SetClusterPolicyLog records a cluster policy change.
type SetClusterPolicyLog struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *SetClusterPolicyLog) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ClusterPolicy) GetIdempotencyTtlMicros() uint64 {
	if x != nil {
		return x.IdempotencyTtlMicros
	}
	return 0
}
...
// projection of the audit log by the usagebuilder subsystem — NOT part of
// the FSM authoritative state. Rebuildable from cursor=0 on demand.
type TemplateUsage struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Count         uint64                 `protobuf:"fixed64,1,opt,name=count,proto3" json:"count,omitempty"`
	LastUsed      *Timestamp             `protobuf:"bytes,2,opt,name=last_used,json=lastUsed,proto3" json:"last_used,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *TemplateUsage) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *TemplateUsage) GetLastUsed() *Timestamp {
	if x != nil {
		return x.LastUsed
	}
	return nil
...
type SinkConfig struct {
	...
	Format        string            `protobuf:"bytes,7,opt,name=format,proto3" json:"format,omitempty"`                                                          // "json" or "protobuf" (default: "json")
...
type SinkConfig_Clickhouse struct {
	Clickhouse *ClickHouseSinkConfig `protobuf:"bytes,3,opt,name=clickhouse,proto3,oneof"`
}

type SinkConfig_Kafka struct {
	Kafka *KafkaSinkConfig `protobuf:"bytes,4,opt,name=kafka,proto3,oneof"`
}

type SinkConfig_Http struct {
	Http *HttpSinkConfig `protobuf:"bytes,5,opt,name=http,proto3,oneof"`
}

type SinkConfig_Databricks struct {
	Databricks *DatabricksSinkConfig `protobuf:"bytes,6,opt,name=databricks,proto3,oneof"`
}
...
type DatabricksSinkConfig struct {
	...
	Catalog        string                 `protobuf:"bytes,3,opt,name=catalog,proto3" json:"catalog,omitempty"`                                     // Unity Catalog name (e.g. "main")
	Schema         string                 `protobuf:"bytes,4,opt,name=schema,proto3" json:"schema,omitempty"`                                       // Schema name (e.g. "default")
	Table          string                 `protobuf:"bytes,5,opt,name=table,proto3" json:"table,omitempty"`                                         // Table name (default: "ledger_events")
	Port           int32                  `protobuf:"varint,6,opt,name=port,proto3" json:"port,omitempty"`                                          // Port number (default: 443)
...
type DatabricksSinkConfig_Token struct {
	Token string `protobuf:"bytes,7,opt,name=token,proto3,oneof"` // Personal Access Token (PAT)
}
...
type LedgerLog struct {
	...
	// Volumes (account+asset) whose PERSISTENT entry was newly created by
	// THIS log AND SURVIVED past commit. New + kept — disjoint from
	// purged_volumes and ephemeral_volumes. The usagebuilder increments
	// VolumeCount by len(new_kept_volumes) — a newly-persisted key raises
	...
	//     purged_volumes ∪ ephemeral_volumes);
	//   - the log payload does not duplicate ephemeral tuples in two lists
...
func (x *LedgerLog) GetNewKeptVolumes() []*TouchedVolume {
	if x != nil {
		return x.NewKeptVolumes
	}
	return nil
}
...
// multi-bucket account. The empty color is the uncolored bucket and is itself
// just another segregated cell.
...
func (x *TouchedVolume) GetColor() string {
	if x != nil {
		return x.Color
	}
	return ""
...
func (x *LedgerLogPayload) GetOrderSkipped() *OrderSkippedLog {
	if x != nil {
		if x, ok := x.Payload.(*LedgerLogPayload_OrderSkipped); ok {
			return x.OrderSkipped
		}
	}
	return nil
}
...
type LedgerLogPayload_FillGap struct {
	FillGap *FilledGapLog `protobuf:"bytes,7,opt,name=fill_gap,json=fillGap,proto3,oneof"`
}

type LedgerLogPayload_CreateIndex struct {
	CreateIndex *CreatedIndexLog `protobuf:"bytes,8,opt,name=create_index,json=createIndex,proto3,oneof"`
}

type LedgerLogPayload_DropIndex struct {
	DropIndex *DroppedIndexLog `protobuf:"bytes,9,opt,name=drop_index,json=dropIndex,proto3,oneof"`
}

type LedgerLogPayload_AddedAccountType struct {
	AddedAccountType *AddedAccountTypeLog `protobuf:"bytes,10,opt,name=added_account_type,json=addedAccountType,proto3,oneof"`
}

type LedgerLogPayload_RemovedAccountType struct {
	RemovedAccountType *RemovedAccountTypeLog `protobuf:"bytes,11,opt,name=removed_account_type,json=removedAccountType,proto3,oneof"`
}

type LedgerLogPayload_UpdatedDefaultEnforcementMode struct {
	UpdatedDefaultEnforcementMode *UpdatedDefaultEnforcementModeLog `protobuf:"bytes,12,opt,name=updated_default_enforcement_mode,json=updatedDefaultEnforcementMode,proto3,oneof"`
}

type LedgerLogPayload_OrderSkipped struct {
	OrderSkipped *OrderSkippedLog `protobuf:"bytes,13,opt,name=order_skipped,json=orderSkipped,proto3,oneof"`
}
...
func (*LedgerLogPayload_OrderSkipped) isLedgerLogPayload_Payload() {}

// OrderSkippedLog records an order that the FSM rejected with a business
// error whose reason was listed in the order's `skippable_reasons` whitelist.
// No state mutation occurred for the skipped order, but the rest of the
// proposal applied normally. The `reason` here is a PROJECTION and is NOT
// hash-chain-bound — only the AuditItem.serialized_order (the submitted
// order, including its allowed skippable_reasons whitelist) is bound. Because
// the projected reason can be tampered with, the checker does not trust it:
// it replays the serialized order against the audit-derived state at the
// applied index, re-derives the failure the FSM must have produced, and
...
func (x *OrderSkippedLog) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
// AggregatedVolume represents aggregated input/output volumes for a single
// (asset, color) bucket. When collapse_colors is requested on the aggregate
// query, all entries are produced with color = "" and amounts summed across
// colors.
...
func (x *AggregatedVolume) GetColor() string {
	if x != nil {
		return x.Color
	}
	return ""
...
type LedgerStats struct {
	...
	ReferenceCount          uint64                 `protobuf:"fixed64,3,opt,name=reference_count,json=referenceCount,proto3" json:"reference_count,omitempty"`
	PostingCount            uint64                 `protobuf:"fixed64,4,opt,name=posting_count,json=postingCount,proto3" json:"posting_count,omitempty"`
	EphemeralEvictedCount   uint64                 `protobuf:"fixed64,5,opt,name=ephemeral_evicted_count,json=ephemeralEvictedCount,proto3" json:"ephemeral_evicted_count,omitempty"`
	TransientUsedCount      uint64                 `protobuf:"fixed64,6,opt,name=transient_used_count,json=transientUsedCount,proto3" json:"transient_used_count,omitempty"`
	RevertCount             uint64                 `protobuf:"fixed64,7,opt,name=revert_count,json=revertCount,proto3" json:"revert_count,omitempty"`
	NumscriptExecutionCount uint64                 `protobuf:"fixed64,8,opt,name=numscript_execution_count,json=numscriptExecutionCount,proto3" json:"numscript_execution_count,omitempty"`
	LogCount                uint64                 `protobuf:"fixed64,9,opt,name=log_count,json=logCount,proto3" json:"log_count,omitempty"`
	unknownFields           protoimpl.UnknownFields
	sizeCache               protoimpl.SizeCache
}
...
type CallerIdentity struct {
	...
	// scopes and god live on CallerSnapshot, not here: CallerIdentity is
...
type CallerIdentity_Issuer struct {
	Issuer string `protobuf:"bytes,2,opt,name=issuer,proto3,oneof"` // OIDC token issuer URL
}

type CallerIdentity_KeyId struct {
	KeyId string `protobuf:"bytes,3,opt,name=key_id,json=keyId,proto3,oneof"` // Ed25519 signing key ID
}

type CallerIdentity_SystemComponent struct {
	SystemComponent string `protobuf:"bytes,4,opt,name=system_component,json=systemComponent,proto3,oneof"` // system/internal actor (no user); names the subsystem
}
...
var file_common_proto_extTypes = []protoimpl.ExtensionInfo{
	{
		...
		ExtensionType: (*MethodAuthPolicy)(nil),
		Field:         71002,
		Name:          "common.auth_policy",
		Tag:           "bytes,71002,opt,name=auth_policy",
...
var (
	// optional common.MethodAuthPolicy auth_policy = 71002;
	E_AuthPolicy = &file_common_proto_extTypes[0]
)

// Extension fields to descriptorpb.FieldOptions.
var (
	// repeated common.QueryTarget allowed_query_targets = 50123;
	E_AllowedQueryTargets = &file_common_proto_extTypes[1]
	...
	E_ValidOnNoQueryTarget = &file_common_proto_extTypes[2]
...
const file_common_proto_rawDesc = "" +
	"\n" +
	"\fcommon.proto\x12\x06common\x1a\x0fsignature.proto\x1a google/protobuf/descriptor.proto\"\xb6\x01\n" +
	"\x10MethodAuthPolicy\x12\x18\n" +
	"\x06public\x18\x01 \x01(\bH\x00R\x06public\x124\n" +
	"\vfixed_scope\x18\x02 \x01(\x0e2\x11.common.AuthScopeH\x00R\n" +
	"fixedScope\x12H\n" +
	"\x10dynamic_resolver\x18\x03 \x01(\x0e2\x1b.common.DynamicAuthResolverH\x00R\x0fdynamicResolverB\b\n" +
	"\x06policy\"\x1f\n" +
	"\tTimestamp\x12\x12\n" +
	...
	"\x05color\x18\x05 \x01(\tR\x05color\"\x96\x05\n" +
	"\vTransaction\x12+\n" +
	...
	"\x13reverts_transaction\x18\v \x01(\x06R\x12revertsTransaction\x12I\n" +
	"\x13post_commit_volumes\x18\f \x01(\v2\x19.common.PostCommitVolumesR\x11postCommitVolumes\x1aR\n" +
	...
	"\x04kind\"\xac\x01\n" +
	"\x05Index\x12\x1f\n" +
	"\x02id\x18\x01 \x01(\v2\x0f.common.IndexIDR\x02id\x120\n" +
	"\n" +
	...
	"\x13removed_events_sink\x18\b \x01(\v2\x1c.common.RemovedEventsSinkLogH\x00R\x11removedEventsSink\x12Q\n" +
	"\x14set_maintenance_mode\x18\t \x01(\v2\x1d.common.SetMaintenanceModeLogH\x00R\x12setMaintenanceMode\x12B\n" +
	"\x0epromote_ledger\x18\n" +
	" \x01(\v2\x19.common.PromotedLedgerLogH\x00R\rpromoteLedger\x12W\n" +
	"\x16created_prepared_query\x18\v \x01(\v2\x1f.common.CreatedPreparedQueryLogH\x00R\x14createdPreparedQuery\x12W\n" +
	"\x16updated_prepared_query\x18\f \x01(\v2\x1f.common.UpdatedPreparedQueryLogH\x00R\x14updatedPreparedQuery\x12W\n" +
	"\x16deleted_prepared_query\x18\r \x01(\v2\x1f.common.DeletedPreparedQueryLogH\x00R\x14deletedPreparedQuery\x12D\n" +
	"\x0fsaved_numscript\x18\x0e \x01(\v2\x19.common.SavedNumscriptLogH\x00R\x0esavedNumscript\x12]\n" +
	"\x18created_query_checkpoint\x18\x0f \x01(\v2!.common.CreatedQueryCheckpointLogH\x00R\x16createdQueryCheckpoint\x12]\n" +
	"\x18deleted_query_checkpoint\x18\x10 \x01(\v2!.common.DeletedQueryCheckpointLogH\x00R\x16deletedQueryCheckpoint\x12j\n" +
	"\x1dset_query_checkpoint_schedule\x18\x11 \x01(\v2%.common.SetQueryCheckpointScheduleLogH\x00R\x1asetQueryCheckpointSchedule\x12t\n" +
	" delete_query_checkpoint_schedule\x18\x12 \x01(\v2).common.DeletedQueryCheckpointScheduleLogH\x00R\x1ddeleteQueryCheckpointSchedule\x12T\n" +
	"\x15saved_ledger_metadata\x18\x13 \x01(\v2\x1e.common.SavedLedgerMetadataLogH\x00R\x13savedLedgerMetadata\x12Z\n" +
	"\x17deleted_ledger_metadata\x18\x14 \x01(\v2 .common.DeletedLedgerMetadataLogH\x00R\x15deletedLedgerMetadata\x12K\n" +
	"\x12set_cluster_policy\x18\x15 \x01(\v2\x1b.common.SetClusterPolicyLogH\x00R\x10setClusterPolicyB\x06\n" +
	"\x04type\"'\n" +
	...
	"\n" +
	"clickhouse\x18\x03 \x01(\v2\x1c.common.ClickHouseSinkConfigH\x00R\n" +
	"clickhouse\x12/\n" +
	"\x05kafka\x18\x04 \x01(\v2\x17.common.KafkaSinkConfigH\x00R\x05kafka\x12,\n" +
	"\x04http\x18\x05 \x01(\v2\x16.common.HttpSinkConfigH\x00R\x04http\x12>\n" +
	"\n" +
	"databricks\x18\x06 \x01(\v2\x1c.common.DatabricksSinkConfigH\x00R\n" +
	"databricks\x12\x16\n" +
	...
	"\x03key\x18\x01 \x01(\tR\x03key\x12)\n" +
	"\x05value\x18\x02 \x01(\v2\x13.common.MetadataMapR\x05value:\x028\x01\"\x91\x01\n" +
	"\x13RevertedTransaction\x126\n" +
	"\x17reverted_transaction_id\x18\x01 \x01(\x06R\x15revertedTransactionId\x12B\n" +
	"\x12revert_transaction\x18\x02 \x01(\v2\x13.common.TransactionR\x11revertTransaction\"\xcc\x01\n" +
	"\rSavedMetadata\x12&\n" +
	...
	"\rdropped_index\x18\x03 \x01(\v2\x0f.common.IndexIDR\fdroppedIndex\"\x94\x02\n" +
	...
	"\raccount_types\x18\b \x03(\v2$.common.LedgerInfo.AccountTypesEntryR\faccountTypes\x12V\n" +
	"\x18default_enforcement_mode\x18\t \x01(\x0e2\x1c.common.ChartEnforcementModeR\x16defaultEnforcementMode\x12<\n" +
	"\bmetadata\x18\n" +
	" \x03(\v2 .common.LedgerInfo.MetadataEntryR\bmetadata\x12\x0e\n" +
	"\x02id\x18\v \x01(\rR\x02id\x1aT\n" +
	"\x11AccountTypesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12)\n" +
	...
	"\x0freference_count\x18\x03 \x01(\x06R\x0ereferenceCount\x12#\n" +
	"\rposting_count\x18\x04 \x01(\x06R\fpostingCount\x126\n" +
	"\x17ephemeral_evicted_count\x18\x05 \x01(\x06R\x15ephemeralEvictedCount\x120\n" +
	...
	"\x06key_id\x18\x03 \x01(\tH\x00R\x05keyId\x12+\n" +
	"\x10system_component\x18\x04 \x01(\tH\x00R\x0fsystemComponentB\b\n" +
	"\x06source\"n\n" +
	...
	"\x06filter\x18\x05 \x01(\v2\x13.common.QueryFilterR\x06filter*\xbb\x03\n" +
	"\tAuthScope\x12\x1a\n" +
	"\x16AUTH_SCOPE_UNSPECIFIED\x10\x00\x12\x1a\n" +
	"\x16AUTH_SCOPE_LEDGER_READ\x10\x01\x12\x1b\n" +
	"\x17AUTH_SCOPE_LEDGER_WRITE\x10\x02\x12\x1f\n" +
	"\x1bAUTH_SCOPE_TRANSACTION_READ\x10\x03\x12 \n" +
	"\x1cAUTH_SCOPE_TRANSACTION_WRITE\x10\x04\x12\x1b\n" +
	"\x17AUTH_SCOPE_ACCOUNT_READ\x10\x05\x12\x1d\n" +
	"\x19AUTH_SCOPE_METADATA_WRITE\x10\x06\x12\x19\n" +
	"\x15AUTH_SCOPE_AUDIT_READ\x10\a\x12\x1a\n" +
	"\x16AUTH_SCOPE_AUDIT_WRITE\x10\b\x12\x17\n" +
	"\x13AUTH_SCOPE_OPS_READ\x10\t\x12\x18\n" +
	"\x14AUTH_SCOPE_OPS_WRITE\x10\n" +
	"\x12\x19\n" +
	"\x15AUTH_SCOPE_QUERY_READ\x10\v\x12\x1a\n" +
	"\x16AUTH_SCOPE_QUERY_WRITE\x10\f\x12\x1b\n" +
	"\x17AUTH_SCOPE_CLUSTER_READ\x10\r\x12\x1c\n" +
	"\x18AUTH_SCOPE_CLUSTER_WRITE\x10\x0e*\xdc\x01\n" +
	"\x13DynamicAuthResolver\x12%\n" +
	"!DYNAMIC_AUTH_RESOLVER_UNSPECIFIED\x10\x00\x12\x1f\n" +
	"\x1bDYNAMIC_AUTH_RESOLVER_APPLY\x10\x01\x12#\n" +
	"\x1fDYNAMIC_AUTH_RESOLVER_GET_INDEX\x10\x02\x120\n" +
	",DYNAMIC_AUTH_RESOLVER_GET_INDEX_ENTRY_STATUS\x10\x03\x12&\n" +
	"\"DYNAMIC_AUTH_RESOLVER_LIST_INDEXES\x10\x04*Z\n" +
	"\n" +
	"TargetType\x12\x17\n" +
	...
	"\x18ACCT_BUILTIN_INDEX_ASSET\x10\x01*P\n" +
	"\x0fLogBuiltinIndex\x12!\n" +
	"\x1dLOG_BUILTIN_INDEX_UNSPECIFIED\x10\x00\x12\x1a\n" +
	"\x16LOG_BUILTIN_INDEX_DATE\x10\x01*C\n" +
	...
	"\x1fERROR_REASON_METADATA_NOT_FOUND\x10\x12\x12!\n" +
	"\x1dERROR_REASON_MAINTENANCE_MODE\x10\x13\x12\x1f\n" +
	"\x1bERROR_REASON_STALE_PROPOSAL\x10\x14\x12(\n" +
	"$ERROR_REASON_INVALID_CRON_EXPRESSION\x10\x15\x12&\n" +
	"\"ERROR_REASON_LEDGER_IN_MIRROR_MODE\x10\x16\x12*\n" +
	"&ERROR_REASON_LEDGER_NOT_IN_MIRROR_MODE\x10\x17\x12.\n" +
	"*ERROR_REASON_PREPARED_QUERY_ALREADY_EXISTS\x10\x18\x12)\n" +
	"%ERROR_REASON_PREPARED_QUERY_NOT_FOUND\x10\x19\x12 \n" +
	"\x1cERROR_REASON_INDEX_NOT_FOUND\x10\x1a\x12\x1f\n" +
	"\x1bERROR_REASON_INDEX_BUILDING\x10\x1b\x12#\n" +
	"\x1fERROR_REASON_INDEX_INCONSISTENT\x10\x1c\x12-\n" +
	")ERROR_REASON_METADATA_FIELD_NOT_IN_SCHEMA\x10\x1d\x12$\n" +
	" ERROR_REASON_NUMSCRIPT_NOT_FOUND\x10\x1e\x121\n" +
	"-ERROR_REASON_NUMSCRIPT_VERSION_ALREADY_EXISTS\x10\x1f\x12*\n" +
	...
	"\x1fERROR_REASON_INVALID_ORDER_TYPE\x10)\x12#\n" +
	"\x1fERROR_REASON_INVALID_APPLY_TYPE\x10*\x12'\n" +
	"#ERROR_REASON_INVALID_EXECUTION_PLAN\x10+\x12)\n" +
	"%ERROR_REASON_EXECUTION_PLAN_TOO_LARGE\x10,\x12\x1e\n" +
	"\x1aERROR_REASON_COVERAGE_MISS\x10-\x12)\n" +
	"%ERROR_REASON_IDEMPOTENCY_CHECK_FAILED\x10.\x12)\n" +
	"%ERROR_REASON_STORAGE_OPERATION_FAILED\x10/\x12/\n" +
	"+ERROR_REASON_TRANSACTION_STATE_INCONSISTENT\x100\x12'\n" +
	"#ERROR_REASON_CHECKPOINT_ID_REQUIRED\x101\x12\"\n" +
	"\x1eERROR_REASON_NUMSCRIPT_RUNTIME\x102\x12(\n" +
	"$ERROR_REASON_VOLUME_NOT_MATERIALIZED\x103\x12\"\n" +
	"\x1eERROR_REASON_CLUSTER_UNHEALTHY\x104\x12)\n" +
	"%ERROR_REASON_WRITES_BLOCKED_DISK_FULL\x105\x12*\n" +
	"&ERROR_REASON_WRITES_BLOCKED_CLOCK_SKEW\x106\x12%\n" +
	"!ERROR_REASON_CHECKPOINT_NOT_READY\x107\x12%\n" +
	"!ERROR_REASON_MIRROR_V2_LOG_ID_GAP\x108\x12)\n" +
	"%ERROR_REASON_MIRROR_V2_LOG_ID_INVALID\x109\x12(\n" +
	...
	"\x1cQUERY_MODE_AGGREGATE_VOLUMES\x10\x01:[\n" +
	"\vauth_policy\x12\x1e.google.protobuf.MethodOptions\x18ڪ\x04 \x01(\v2\x18.common.MethodAuthPolicyR\n" +
	"authPolicy:h\n" +
	...
	"\x15ledger_log_is_history\x12\x1d.google.protobuf.FieldOptions\x18͇\x03 \x01(\bR\x12ledgerLogIsHistoryBAZ?github.com/formancehq/reconciliation/internal/ledgerpb/commonpbb\x06proto3"
...
var file_common_proto_msgTypes = make([]protoimpl.MessageInfo, 174)
var file_common_proto_goTypes = []any{
	(AuthScope)(0),                                   // 0: common.AuthScope
	(DynamicAuthResolver)(0),                         // 1: common.DynamicAuthResolver
	(TargetType)(0),                                  // 2: common.TargetType
	(MetadataType)(0),                                // 3: common.MetadataType
	...
	(*MethodAuthPolicy)(nil),                         // 18: common.MethodAuthPolicy
	(*Timestamp)(nil),                                // 19: common.Timestamp
	(*NullValue)(nil),                                // 20: common.NullValue
	(*MetadataValue)(nil),                            // 21: common.MetadataValue
	(*MetadataMap)(nil),                              // 22: common.MetadataMap
	(*ParameterValue)(nil),                           // 23: common.ParameterValue
	(*Uint256)(nil),                                  // 24: common.Uint256
	...
	(*CallerSnapshot)(nil),                           // 167: common.CallerSnapshot
	(*S3StorageConfig)(nil),                          // 168: common.S3StorageConfig
	(*AzureStorageConfig)(nil),                       // 169: common.AzureStorageConfig
	(*BackupStorage)(nil),                            // 170: common.BackupStorage
	(*ReadOptions)(nil),                              // 171: common.ReadOptions
	(*ListOptions)(nil),                              // 172: common.ListOptions
	nil,                                              // 173: common.MetadataMap.ValuesEntry
	nil,                                              // 174: common.Transaction.MetadataEntry
	nil,                                              // 175: common.Script.VarsEntry
	nil,                                              // 176: common.PostCommitVolumes.VolumesByAccountEntry
	nil,                                              // 177: common.Account.MetadataEntry
	nil,                                              // 178: common.MetadataSchema.AccountFieldsEntry
	nil,                                              // 179: common.MetadataSchema.TransactionFieldsEntry
	nil,                                              // 180: common.MetadataSchema.LedgerFieldsEntry
	nil,                                              // 181: common.SavedLedgerMetadataLog.MetadataEntry
	nil,                                              // 182: common.CreatedLedgerLog.AccountTypesEntry
	nil,                                              // 183: common.OrderSkippedLog.ContextEntry
	...
	(*descriptorpb.MethodOptions)(nil),               // 193: google.protobuf.MethodOptions
	(*descriptorpb.FieldOptions)(nil),                // 194: google.protobuf.FieldOptions
}
var file_common_proto_depIdxs = []int32{
	...
	173, // 3: common.MetadataMap.values:type_name -> common.MetadataMap.ValuesEntry
	24,  // 4: common.Posting.amount:type_name -> common.Uint256
	25,  // 5: common.Transaction.postings:type_name -> common.Posting
	174, // 6: common.Transaction.metadata:type_name -> common.Transaction.MetadataEntry
	...
	175, // 12: common.Script.vars:type_name -> common.Script.VarsEntry
	...
	176, // 15: common.PostCommitVolumes.volumes_by_account:type_name -> common.PostCommitVolumes.VolumesByAccountEntry
	29,  // 16: common.AccountVolume.volumes:type_name -> common.VolumesWithBalance
	177, // 17: common.Account.metadata:type_name -> common.Account.MetadataEntry
	...
	178, // 24: common.MetadataSchema.account_fields:type_name -> common.MetadataSchema.AccountFieldsEntry
	179, // 25: common.MetadataSchema.transaction_fields:type_name -> common.MetadataSchema.TransactionFieldsEntry
	180, // 26: common.MetadataSchema.ledger_fields:type_name -> common.MetadataSchema.LedgerFieldsEntry
	...
	192, // 37: common.Log.response_signature:type_name -> signature.SignedLog
	...
	181, // 78: common.SavedLedgerMetadataLog.metadata:type_name -> common.SavedLedgerMetadataLog.MetadataEntry
	...
	182, // 97: common.CreatedLedgerLog.account_types:type_name -> common.CreatedLedgerLog.AccountTypesEntry
	...
	183, // 120: common.OrderSkippedLog.context:type_name -> common.OrderSkippedLog.ContextEntry
	...
	184, // 125: common.CreatedTransaction.account_metadata:type_name -> common.CreatedTransaction.AccountMetadataEntry
	...
	185, // 128: common.SavedMetadata.metadata:type_name -> common.SavedMetadata.MetadataEntry
	...
	186, // 178: common.LedgerInfo.account_types:type_name -> common.LedgerInfo.AccountTypesEntry
	12,  // 179: common.LedgerInfo.default_enforcement_mode:type_name -> common.ChartEnforcementMode
	187, // 180: common.LedgerInfo.metadata:type_name -> common.LedgerInfo.MetadataEntry
	36,  // 181: common.SaveMetadataCommand.target:type_name -> common.Target
	188, // 182: common.SaveMetadataCommand.metadata:type_name -> common.SaveMetadataCommand.MetadataEntry
	36,  // 183: common.DeleteMetadataCommand.target:type_name -> common.Target
	189, // 184: common.TransactionState.metadata:type_name -> common.TransactionState.MetadataEntry
	...
	190, // 190: common.IdempotencyFailure.metadata:type_name -> common.IdempotencyFailure.MetadataEntry
	...
	191, // 195: common.AccountType.segment_types:type_name -> common.AccountType.SegmentTypesEntry
	...
	166, // 241: common.CallerSnapshot.identity:type_name -> common.CallerIdentity
	168, // 242: common.BackupStorage.s3:type_name -> common.S3StorageConfig
	169, // 243: common.BackupStorage.azure:type_name -> common.AzureStorageConfig
	171, // 244: common.ListOptions.read:type_name -> common.ReadOptions
	139, // 245: common.ListOptions.filter:type_name -> common.QueryFilter
	21,  // 246: common.MetadataMap.ValuesEntry.value:type_name -> common.MetadataValue
	21,  // 247: common.Transaction.MetadataEntry.value:type_name -> common.MetadataValue
	30,  // 248: common.PostCommitVolumes.VolumesByAccountEntry.value:type_name -> common.VolumesByAssets
	21,  // 249: common.Account.MetadataEntry.value:type_name -> common.MetadataValue
	37,  // 250: common.MetadataSchema.AccountFieldsEntry.value:type_name -> common.MetadataFieldSchema
	37,  // 251: common.MetadataSchema.TransactionFieldsEntry.value:type_name -> common.MetadataFieldSchema
	37,  // 252: common.MetadataSchema.LedgerFieldsEntry.value:type_name -> common.MetadataFieldSchema
	21,  // 253: common.SavedLedgerMetadataLog.MetadataEntry.value:type_name -> common.MetadataValue
	135, // 254: common.CreatedLedgerLog.AccountTypesEntry.value:type_name -> common.AccountType
	22,  // 255: common.CreatedTransaction.AccountMetadataEntry.value:type_name -> common.MetadataMap
	21,  // 256: common.SavedMetadata.MetadataEntry.value:type_name -> common.MetadataValue
	135, // 257: common.LedgerInfo.AccountTypesEntry.value:type_name -> common.AccountType
	21,  // 258: common.LedgerInfo.MetadataEntry.value:type_name -> common.MetadataValue
	21,  // 259: common.SaveMetadataCommand.MetadataEntry.value:type_name -> common.MetadataValue
	21,  // 260: common.TransactionState.MetadataEntry.value:type_name -> common.MetadataValue
	131, // 261: common.AccountType.SegmentTypesEntry.value:type_name -> common.SegmentType
	193, // 262: common.auth_policy:extendee -> google.protobuf.MethodOptions
	194, // 263: common.allowed_query_targets:extendee -> google.protobuf.FieldOptions
	194, // 264: common.valid_on_no_query_target:extendee -> google.protobuf.FieldOptions
	194, // 265: common.ledger_log_is_history:extendee -> google.protobuf.FieldOptions
	18,  // 266: common.auth_policy:type_name -> common.MethodAuthPolicy
	...
	266, // [266:268] is the sub-list for extension type_name
	262, // [262:266] is the sub-list for extension extendee
...
func file_common_proto_init() {
	...
	file_common_proto_msgTypes[0].OneofWrappers = []any{
		(*MethodAuthPolicy_Public)(nil),
		(*MethodAuthPolicy_FixedScope)(nil),
		(*MethodAuthPolicy_DynamicResolver)(nil),
	}
