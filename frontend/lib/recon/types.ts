...
export interface BalanceEquationEvidence {
  schemaVersion: 2
...
export interface SourceConsensusEvidence {
  schemaVersion: 2
 ...
 */
export interface StaleHoldsEvidence {
  schemaVersion: 2
...
export interface BalanceBoundsEvidence {
  schemaVersion: 2
