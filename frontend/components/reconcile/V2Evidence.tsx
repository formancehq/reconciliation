...
function ControlFailure({ children }: { children: React.ReactNode }) {
  return (
    <div className="flex items-start gap-2 rounded-md border border-destructive-foreground/30 border-l-2 border-l-destructive-foreground bg-destructive/10 px-3 py-2 text-sm font-medium text-destructive-foreground">
