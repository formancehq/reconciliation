...
import (
	...
	reconciliationcomponent "github.com/formancehq/reconciliation/plugins/fctl/component"
...
func mustLifecycle() *component.Component {
	configured, err := component.NewCommand(core.Plugin{}, reconciliationcomponent.Descriptor())
	if err != nil {
		panic(fmt.Sprintf("configure reconciliation portable component: %v", err))
	}
	return configured
}
